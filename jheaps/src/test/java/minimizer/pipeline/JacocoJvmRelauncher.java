...
final class JacocoJvmRelauncher {
    ...
    static int relaunchWithJacocoAgent(Class<?> mainClass, String[] args) throws IOException, InterruptedException {
        ...
        command.add(javaBin);
        command.add("-javaagent:" + agentJar + "=output=none,dumponexit=false,includes=" + jacocoIncludes());
    ...
    private static String jacocoIncludes() {
        return System.getProperty("minimizer.jacoco.includes", "org.jheaps.*");
    }
}
